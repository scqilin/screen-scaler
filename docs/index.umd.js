(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ScreenScaler = {}));
    ...
    class ScreenScaler {
        constructor(config) {
            ...
            // 初始化用户容器
            const userContainer = typeof config.container === 'string' ? document.querySelector(config.container) : config.container;
            if (!userContainer) {
    ...
    exports.ScreenScaler = ScreenScaler;
    exports["default"] = ScreenScaler;
